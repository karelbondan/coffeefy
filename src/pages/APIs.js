                ...
                <div className='flex space-x-3'>
                    ...
                    <div className='w-[400px] h-full flex flex-col space-y-4 px-10 py-10 rounded-2xl bg-slate-700'>
                        ...
                        <form className='text-white space-y-3 pt-5' onSubmit={signIn}>
                            ...
                            <div className='space-y-1'>
                                <label>Password</label>
                                <input onChange={setChangeSignUp} name='password' required placeholder='Password' type='text' className='py-2 px-3 outline-none w-full bg-transparent border border-slate-400 rounded-full hover:bg-slate-600 transition-all focus:bg-yellow-600 focus:border-yellow-500 focus:bg-opacity-40' />
                            </div>
                            <div className='space-y-1'>
                                <label>Confirm password</label>
                                <input onChange={setChangeSignUp} name='confirm_p' required placeholder='Confirm password' type='text' className='py-2 px-3 outline-none w-full bg-transparent border border-slate-400 rounded-full hover:bg-slate-600 transition-all focus:bg-yellow-600 focus:border-yellow-500 focus:bg-opacity-40' />
                            </div>
                            <div className='flex items-center justify-center pt-5'>
